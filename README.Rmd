...
- **Integración Flexible con Python:** Permite conectar directamente mediante la API de Python a través de `reticulate` o usar el ejecutable ejecutable CLI (`markitdown`).
